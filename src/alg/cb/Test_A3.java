...
public class Test_A3 {
	public static void main(String[] args) {	
		...
		String[] labels = {"Popularity", "Genre Overlap", "Genre Jaccard", "Genome Cosine", "Ratings Cosine", "Confidence", "Genome/Ratings", "Genome/Quality"};
	...
	public static Matrix calculateSimilarities(SimilarityMetric metric, Casebase cb) {
		...
		for (int i = 0; i < movies.length; i++)
			for (int j = i + 1; j < movies.length; j++) {
				...
				// Similarities calculated using genre overlap, genome cosine and 
				// ratings cosine are symmetric - i.e. sim(m1, m2) = sim(m2, m1)
