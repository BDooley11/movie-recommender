...
//		SimilarityMetric metric = new PopularitySimilarity();
//		SimilarityMetric metric = new GenreOverlapSimilarity();
//		SimilarityMetric metric = new GenreJaccardSimilarity();
//		SimilarityMetric metric = new GenomeCosineSimilarity();
//		SimilarityMetric metric = new RatingsCosineSimilarity();
//		SimilarityMetric metric = new ConfidenceSimilarity(threshold);
//		SimilarityMetric metric = new GenomeRatingsSimilarity();
		SimilarityMetric metric = new GenomeQualitySimilarity();
